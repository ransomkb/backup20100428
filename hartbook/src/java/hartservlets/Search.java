...
public final class Search extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
		...
		ss.message = Messages.getMess0(ss);
			...
			//ss.dbgApp("got here Search 1: Search got posted"); //debug

        if(req.getParameter("search") != null)
		{
				//ss.dbgApp("got here Search 2: ss.searchVar = "+req.getParameter("searchvar")); //debug

			ss.searchVar = StringHandler.adjustString(req.getParameter("searchvar"));
				//ss.dbgApp("got here Search 3: ss.searchVar = "+ss.searchVar); //debug
