...
public class HTMLStuff
{
    ...
    {// sets given url as the page from which an action originated
        this.folder = ss.folder;
        ss.exp.folder = this.folder;
        ss.srcPage = "/" + this.folder + "/" + url;
        this.srcpage = ss.srcPage;
    } // sets the "folder" variables for HTMLStuff and Explanations to the same variable in SessionState
    ...
    {// sets HTMLStuff variable "lang" to the same variable in SessionState
        this.lang = ss.lang;
    }
    ...
    private String getVersion()
    {
        if (lang == 1)
        {
            return "<a href='/" + folder + "/front_page.jsp'>English Version</a>";
        } else
        {
            return "<a href='/" + folder + "/front_page.jsp'>日本語訳文</a>";
        }
    }
    ...
    private void setSampLinks()
    {
        String[] linkArrayE =
        {
            "<a href='/" + folder + "/front_page.jsp'>Front Page</a>",
        ...
        String[] linkArrayJ =
        {
            "<a href='/" + folder + "/front_page.jsp'>前面</a>",
    ...
    private void setTinySampLinks()
    {
        String[] smLinkArrayE =
        {
            "<a href='/" + folder + "/front_page.jsp' class='tinylink'>Front Page</a>",
        ...
        String[] smLinkArrayJ =
        {
            "<a href='/" + folder + "/front_page.jsp' class='tinylink'>前面</a>",
        ...
        if (lang == 0)
        {
            linkArraySamp = smLinkArrayE;
        } else
        {
            linkArraySamp = smLinkArrayJ;
        }
    }
    ...
    {// 0=CHANGE-LANG, 1=HOME, 2=EDIT, 3=DISP, 4=HIST, 5=HELP, 6=LOGOUT, 7=ADMIN
        String[] linkArrayE =
        {
            "<a href='/" + folder + "/forlang.jsp' onClick='return popup(this, \"help\", 750, 600)'>Change Language</a>",
        ...
        String[] linkArrayJ =
        {
            "<a href='/" + folder + "/forlang.jsp' onClick='return popup(this, \"help\", 750, 600)'>他の外国語</a>",
        ...
        if (lang == 0)
        {
            linkArray = linkArrayE;
        } else
        {
            linkArray = linkArrayJ;
        }
    ...
    {// 0=CHANGE-LANG, 1=HOME, 2=EDIT, 3=DISP, 4=HIST, 5=HELP, 6=LOGOUT, 7=ADMIN
        String[] smLinkArrayE =
        {
            "<a href='/" + folder + "/forlang.jsp' class='tinylink' onClick='return popup(this, \"help\", 750, 600)'>Change Language</a>",
        ...
        String[] smLinkArrayJ =
        {
            "<a href='/" + folder + "/forlang.jsp' class='tinylink' onClick='return popup(this, \"help\", 750, 600)'>他の外国語</a>",
        ...
        if (lang == 0)
        {
            linkArray = smLinkArrayE;
        } else
        {
            linkArray = smLinkArrayJ;
        }
    }
    ...
    public String getBut10()
    {
        String[] s =
        {
            "<input type='submit' name='addwordsets' value='Try It Out' class='button-lg-mid'/>",
    ...
    public String getBut11()
    {
        String[] s =
        {
            "<input type='submit' name='login' value='Log In' class='button-lg-mid'/>",
    ...
    public String getBut12()
    {
        String[] s =
        {
            "<input type='submit' name='register' value='Register' class='button-lg-mid'/>",
            "<input type='submit' name='register' value='登録' class='button-lg-mid'/>"
        };
        return s[lang];
    }

    public String getButton(String name, String val)
    {
        String button = "<input type='submit' name='" + name + "' value='" + val + "' class='button-lg-mid'/>";
    ...
    public String getRadio(String name, String val)
    {
        String radio = "<input type='radio' name='" + name + "' value='" + val + "'>";

        return radio;
    }

    public String getCheckbox(String name)
    {
        String checkbox = "<input type='checkbox' name='" + name + "'>";

        return checkbox;
    }

    public String getForm(String name, String id, String action, String method, SessionState ss)
    {
        String html = "<form  name='" + name + "' id='" + id + "' action='/" + ss.folder + "/" + action + "' method='" + method + "' accept-charset='UTF-8'>";
