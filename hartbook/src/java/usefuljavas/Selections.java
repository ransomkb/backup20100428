...
public final class Selections
{
    ...
    // IMPORTANT: finish this and apply where useful
    public String getSelect(String name, SessionState ss)
    {
        String select = "<select name='"+name+"' "+style+">"+getOptions(ss)+"</select>";

        return select;
    }


    //IMPORTANT: needs to be adjusted for the various situations. May not be useful.
    public String getOptions(SessionState ss)
    {
		String o = "";
