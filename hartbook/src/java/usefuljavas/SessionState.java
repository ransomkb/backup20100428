...
public final class SessionState implements HttpSessionBindingListener
{
    ...
    /**
     * One instance of this object will be created for each live session. When
     * the session is ended, either because user finishes or timeout, then the
     * instance will be destroyed.
     *
     * We will use public non-local variables to store the state for each
     * session. Then just the session id can be put in either a cookie or a
     * hidden form variable or even on the URL as a querystring param.
     *
     * Then doGet() will match the id to a valid live session instance and that
     * will be used throughout the rest of the request response.
     *
     */
    ...
    /**
     * System.currentTimeMillis() returns the # of milliseconds since Jan 1.
     * 1970 GMT or something like that. we can certainly use it to track the #
     * of seconds elapsed since last browser hit and then expire the session.
     */
    ...
    public WordBean[] a =
    {
        wBean, wBean, wBean, wBean, wBean, wBean
    }; // Array of answers
    public WordBean[] b =
    {
        wBean, wBean, wBean, wBean, wBean, wBean
    ...
    public void setLang()
    {// sets the setLang methods for HTMLStuff and Explanations with SessionState variable "lang"
        this.html.setLang(this);
        this.exp.setLang(this);
    } // default is 0, which ensures output is in English; 1 is J output
    ...
    { // removes the element at key and updates table lists' csvlist to ""
        ...
        } else
        {
            ...
            // updates table lists' csvlist to "" according to passed userID and name, and ss.language
    ...
    public boolean verifyRandomContext(String rc)
    {
        return (rc.compareTo(randomContextCheck) == 0);
    }
    ...
    public void setLists()
    {
        ...
        {
            myList = myListVerbs;
            maybeList = maybeListVerbs;
            knowList = knowListVerbs;
            teachList = teachListVerbs;
        } else if (type.equals("noun"))
        {
            myList = myListNouns;
            maybeList = maybeListNouns;
            knowList = knowListNouns;
            teachList = teachListNouns;
        } else if (type.equals("adjective"))
        {
            myList = myListAdjs;
            maybeList = maybeListAdjs;
            knowList = knowListAdjs;
            teachList = teachListAdjs;
        } else if (type.equals("misc"))
        {
            myList = myListMisc;
            maybeList = maybeListMisc;
            knowList = knowListMisc;
            teachList = teachListMisc;
        }
    }
    ...
    public void setTypes()
    {
        ...
        {
            myListVerbs = myList;
            maybeListVerbs = maybeList;
            knowListVerbs = knowList;
            teachListVerbs = teachList;
        } else if (type.equals("noun"))
        {
            myListNouns = myList;
            maybeListNouns = maybeList;
            knowListNouns = knowList;
            teachListNouns = teachList;
        } else if (type.equals("adjective"))
        {
            myListAdjs = myList;
            maybeListAdjs = maybeList;
            knowListAdjs = knowList;
            teachListAdjs = teachList;
        } else if (type.equals("misc"))
        {
            myListMisc = myList;
            maybeListMisc = maybeList;
            knowListMisc = knowList;
            teachListMisc = teachList;
        }
    }
    ...
    } // sets this.scores to a csv of study data
...
// My methods from the Beans.
    ...
    public void setEngAns(String e)
    {
        engAns = e;
    }

    public String getEngAns()
    {
        return engAns;
    }

    public void setKanAns(String k)
    {
        kanAns = k;
    }

    public String getKanAns()
    {
        return kanAns;
    }

    public void setYomAns(String y)
    {
        yomAns = y;
    }

    public String getYomAns()
    {
        return yomAns;
    }
    ...
    public void setBut4(String b)
    {
        but4 = b;
    }

    public String getBut4()
    {
        return but4;
    }

    public void setBut5(String b)
    {
        but5 = b;
    }

    public String getBut5()
    {
        return but5;
    }

    public void setBut6(String b)
    {
        but6 = b;
    }

    public String getBut6()
    {
        return but6;
    }

    public void setBut7(String b)
    {
        but7 = b;
    }

    public String getBut7()
    {
        return but7;
    }

    public void dbgApp(String msg)
    {
        debugString += msg + '\n';
    }
}
