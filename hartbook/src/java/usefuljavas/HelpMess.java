...
{   
	...
	// HOME(0), GETLIST(1), STUDY(2), REVIEW(3), TEST(4), EDITROWS(5), DISPLAY(6), HISTORY(7), QUIZ(8);
        String helpMe = ""; // used to return the string of messages associated with a given page
        ...
        {//STUDY(2)
            return helpMe = "<!-- About Study --><tr><td>"+
                    ...
                    "</p><p class='p'>"+getHelp111(ss)+
                    "</p><p class='p'>"+getHelp110(ss)+
                    "</p></td></tr>";// getHelp111
        }
	...
	private static String getHelp2A(SessionState ss)
	{
		String[] s = {"<u>Home</u>", 
			"<u>ホーム</u>"};
		return s[ss.lang];
	...
	private static String getHelp2(SessionState ss)
	{
		String[] s = {"<u>Links</u>", 
			"<u>リンク</u>"};
		return s[ss.lang];
	...
	private static String getHelp3(SessionState ss)
	{
	...
	private static String getHelp6(SessionState ss)
	{
	...
	private static String getHelp7(SessionState ss)
	{
	...
	private static String getHelp8(SessionState ss)
	{
	...
	// About My Lists
	private static String getHelp9(SessionState ss)
	{
	...
	// About Study
	private static String getHelp20(SessionState ss)
	{
		String[] s = {"<u>Study</u>",
			"<u>勉強</u>"};
		return s[ss.lang];
	...
	// About Test
	private static String getHelp23(SessionState ss)
	{
		String[] s = {"<u>Test</u>",
			"<u>テスト</u>"};
		return s[ss.lang];
	...
	// About Review
	private static String getHelp28(SessionState ss)
	{
		String[] s = {"<u>Review</u>",
			"<u>復習</u>"};
		return s[ss.lang];
	...
	// About Display Lists
	private static String getHelp40(SessionState ss)
	{
	...
	// About Study History
	private static String getHelp45(SessionState ss)
	{
	...
	//About Edit Rows
	private static String getHelp50(SessionState ss)
	{
	...
	// About CreateQuiz
	private static String getHelp60(SessionState ss)
	{
	...
	// Home
	private static String getHelp66(SessionState ss)
	{
	...
	private static String getHelp67(SessionState ss)
	{
	...
	// GetLists
	private static String getHelp68(SessionState ss)
	{
	...
	private static String getHelp69(SessionState ss)
	{
	...
	private static String getHelp70(SessionState ss)
	{
	...
	private static String getHelp71(SessionState ss)
	{
	...
	private static String getHelp72(SessionState ss)
	{
	...
	// Study
	private static String getHelp73(SessionState ss)
	{
	...
	private static String getHelp74(SessionState ss)
	{
	...
	private static String getHelp75(SessionState ss)
	{
	...
	// Review
	private static String getHelp76(SessionState ss)
	{
	...
	private static String getHelp77(SessionState ss)
	{
	...
	private static String getHelp78(SessionState ss)
	{
	...
	private static String getHelp79(SessionState ss)
	{
	...
	// Test
	private static String getHelp80(SessionState ss)
	{
	...
	private static String getHelp81(SessionState ss)
	{
	...
	private static String getHelp82(SessionState ss)
	{
	...
	private static String getHelp83(SessionState ss)
	{
	...
	private static String getHelp84(SessionState ss)
	{
	...
	// Display Lists
	private static String getHelp85(SessionState ss)
	{
	...
	private static String getHelp86(SessionState ss)
	{
	...
	private static String getHelp87(SessionState ss)
	{
	...
	// translation needs editing
	private static String getHelp88(SessionState ss)
	{
		String[] s = {"<b>Move</b> – To remove one row or many rows from the displayed list and add it/them to one of the 3 main lists:<ol class='listings'><li>Click on the check box at the end of the row(s).</li><li>Select a list to add the row(s) to.</li><li>Click on the Move button.</li></ol>",
	...
	// Edit Rows
	private static String getHelp89(SessionState ss)
	{
	...
	private static String getHelp90(SessionState ss)
	{
	...
	private static String getHelp91(SessionState ss)
	{
	...
	private static String getHelp92(SessionState ss)
	{
	...
	private static String getHelp93(SessionState ss)
	{
	...
	private static String getHelp94(SessionState ss)
	{
    ...
    private static String getHelp95(SessionState ss)
    {
        String helper = "";

        if(ss.language.equals("japanese"))
            helper = getHelp95A(ss);
        else
            helper = getHelp95B(ss);
        
        return helper;
    }
	
	private static String getHelp95A(SessionState ss)
	{
	...
	// translation needs editing
	private static String getHelp95B(SessionState ss)
	{
		String[] s = {"<b>Add Row</b> - To add meanings to the database and your list:<ol class='listings'><li>Make sure you have selected the correct list and clicked on the Display button.</li><li>Select the type.</li><li>Enter <b>one</b> English meaning.</li><li>Enter <b>one</b> meaning in "+ss.language+", in the original script.</li><li>(If the script is a pictograph, enter <b>one</b> meaning in a script for pronunciation.)</li><li>Click on the Add Row button.</li></ol><p class='p'>Hart Book will check whether such a row of meanings already exists in the database table. If it exists, then that row will just be added to your list. If not, Hart Book will create a new row with these meanings and add that row to your list.</p>",
			"<b>単語の追加</b>―データベースとリストに新たな意味を追加します。<ol class='listings'><li>選択したリストが正しいか確かめてから表示ボタンをクリックします。</li><li>タイプを選択します。</li><li>6.	英語の意味を<b>一つ</b>入力します。</li><li>日本語の意味を漢字で<b>一つ</b>入力します。</li><li>日本語の意味をひらがな又はカタカナで<b>一つ</b>入力します。</li><li>単語の追加ボタンをクリックします。</li></ol><p>Hart Bookはその単語の意味が既にデータベースに存在するか否かを自動的に調べます。もし存在している場合は、貴方のリストにのみ追加します。そうでない場合Hart Bookは新しい単語とその意味を作成し貴方のリストに追加します。</p>"};
		return s[ss.lang];
	}

	
	private static String getHelp96(SessionState ss)
	{
	...
	private static String getHelp97(SessionState ss)
	{
	...
	// Study History
	private static String getHelp98(SessionState ss)
	{
	...
	private static String getHelp99(SessionState ss)
	{
	...
	private static String getHelp100(SessionState ss)
	{
	...
	private static String getHelp101(SessionState ss)
	{
	...
	private static String getHelp102(SessionState ss)
	{
	...
	// Create Quiz
	private static String getHelp103(SessionState ss)
	{
	...
	private static String getHelp104(SessionState ss)
	{
	...
	private static String getHelp105(SessionState ss)
	{
	...
	private static String getHelp106(SessionState ss)
	{
	...
	// needs translation
	private static String getHelp107(SessionState ss)
	{
	...
	// needs translation
	private static String getHelp108(SessionState ss)
	{
	...
	// needs translation
	private static String getHelp109(SessionState ss)
	{
		String[] s = {"<b>Partial / Whole List</b> - If you choose Whole List, even the words that have been placed on Know or Maybe Know lists will be included in the random selection for the study list.",
			"japanese"};
		return s[ss.lang];
	}
	...
	// needs translation
	private static String getHelp110(SessionState ss)
	{
		String[] s = {"<b>Home Link</b> - Click on the Home link at the top of the page for other activities.",
			"japanese"};
		return s[ss.lang];
	}
	...
	// needs translation
	private static String getHelp111(SessionState ss)
	{
		String[] s = {"<b>Roll-Over</b> - If you Roll-Over any of the meanings that appear on the right, any example sentences in the database will appear above the study word.",
			"japanese"};
		return s[ss.lang];
	}

   // needs translation
	private static String getHelp112(SessionState ss)
	{
		String[] s = {"<b>Add Example Sentences</b> - If you would like to add example sentences for a row, click on the Example Sentences link. Then, enter an example in both English and the other language in the popup window.",
			"japanese"};
		return s[ss.lang];
	}
    ...
    // template
	// needs translation
	private static String getHelp(SessionState ss)
	{
    ...
    /*
	// the methods below are no longer used, I think, but keep them for possible need
	private static String getHelp4(SessionState ss)
	{
	...
	// no longer used
	private static String getHelp5(SessionState ss)
	{
	...
	private static String getHelp10(SessionState ss)
	{
	...
	private static String getHelp11(SessionState ss)
	{
	...
	private static String getHelp12(SessionState ss)
	{
	...
	private static String getHelp13(SessionState ss)
	{
	...
	private static String getHelp14(SessionState ss)
	{
	...
	private static String getHelp15(SessionState ss)
	{
	...
	private static String getHelp16(SessionState ss)
	{
	...
	private static String getHelp17(SessionState ss)
	{
	...
	private static String getHelp18(SessionState ss)
	{
	...
	private static String getHelp19(SessionState ss)
	{
	...
	private static String getHelp21(SessionState ss)
	{
	...
	private static String getHelp22(SessionState ss)
	{
	...
	private static String getHelp24(SessionState ss)
	{
	...
	private static String getHelp25(SessionState ss)
	{
	...
	private static String getHelp26(SessionState ss)
	{
	...
	private static String getHelp27(SessionState ss)
	{
	...
	private static String getHelp29(SessionState ss)
	{
	...
	private static String getHelp30(SessionState ss)
	{
	...
	private static String getHelp31(SessionState ss)
	{
	...
	private static String getHelp32(SessionState ss)
	{
	...
	private static String getHelp33(SessionState ss)
	{
	...
	private static String getHelp34(SessionState ss)
	{
	...
	// About Teacher Lists
	private static String getHelp35(SessionState ss)
	{
	...
	private static String getHelp36(SessionState ss)
	{
	...
	private static String getHelp37(SessionState ss)
	{
	...
	private static String getHelp38(SessionState ss)
	{
	...
	private static String getHelp39(SessionState ss)
	{
	...
	private static String getHelp41(SessionState ss)
	{
	...
	private static String getHelp42(SessionState ss)
	{
	...
	private static String getHelp43(SessionState ss)
	{
	...
	private static String getHelp44(SessionState ss)
	{
	...
	private static String getHelp46(SessionState ss)
	{
	...
	private static String getHelp47(SessionState ss)
	{
	...
	private static String getHelp48(SessionState ss)
	{
	...
	private static String getHelp49(SessionState ss)
	{
	...
	private static String getHelp51(SessionState ss)
	{
	...
	private static String getHelp52(SessionState ss)
	{
	...
	private static String getHelp53(SessionState ss)
	{
	...
	private static String getHelp54(SessionState ss)
	{
	...
	private static String getHelp55(SessionState ss)
	{
	...
	private static String getHelp56(SessionState ss)
	{
	...
	private static String getHelp57(SessionState ss)
	{
	...
	private static String getHelp58(SessionState ss)
	{
	...
	private static String getHelp59(SessionState ss)
	{
	...
	private static String getHelp61(SessionState ss)
	{
	...
	private static String getHelp62(SessionState ss)
	{
	...
	private static String getHelp63(SessionState ss)
	{
	...
	private static String getHelp64(SessionState ss)
	{
	...
	private static String getHelp65(SessionState ss)
	{
