...
public final class Messages 
{
	...
	// Important: needs to be translated
    // returns a mess of
	public static String getMess56(SessionState ss)
	{
		String[] s = {"Sorry, but the rows in that list are all in the Know or Maybe Know lists. Choose Whole List or move the rows to My List on the DisplayLists page.",
			"japanese"};
		return s[ss.lang];
	}
