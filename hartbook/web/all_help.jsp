...
<%
    ...
    ss = (SessionState) session.getAttribute("Session"); // obtains the SessionState assigned to the user's session
    if (ss != null)
    {
        DBHandler.saveState(ss); // saves the important variables in the database for the user
    }
    else
    { // sends the user back to the beginning to get a SessionState and log in.
    %>
        <jsp:forward page = "GetSessionState" />
    <%
    }
    // IMPORTANT: this may not work anymore. Is it necessary?
    ss.fullHelp = "help_edit_rows2.jsp"; // option to show the user all the help messages
%>
        ...
        <table cellpadding="0" cellspacing="0" border="0" align="center" width="690">
            ...
            <tr>
                ...
                <!-- Section Header --><!-- Some text --> 
                    <table width="100%">
                    <!-- Link to see the full Help page; IMPORTANT: may not be needed
                        <tr>
                            <td>
                        ...
                        <!-- all of the help messages associated with the page are displayed from here -->
